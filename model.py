...
xgb_model = RandomizedSearchCV(xgb_model, param_distributions, scoring='neg_mean_squared_error', n_iter=100, cv=3, random_state=42)
...
# xgb.plot_importance(xgb_model.best_estimator_)  # 'best_estimator_' if using RandomizedSearchCV
# plt.show()
...
print(xgb_model.predict(user_input_df)[0])